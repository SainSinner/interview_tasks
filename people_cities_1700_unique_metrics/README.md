...
![fn_people_lastName_firstName.png](PNG%2fn_people_lastName_firstName.png)

#### Функция поиска человека по фамилии

![fn_people_lastName.png](PNG%2fn_people_lastName.png)
 
#### Функция, предоставляющая исходные данные по конкретному гражданину. За весь период времени

![fn_citizen_data_history.png](PNG%2fn_citizen_data_history.png)
 
#### Функция, предоставляющая исходные данные по конкретному гражданину. За весь указанный промежуток времени

![fn_citizen_data_history_filter.png](PNG%2fn_citizen_data_history_filter.png)
...
![fn_citizen_data_history_filter_agg_month.png](PNG%2fn_citizen_data_history_filter_agg_month.png)
...
![fn_citizen_data_history_filter_agg_day.png](PNG%2fn_citizen_data_history_filter_agg_day.png)
...
![fn_citizen_data_history_filter_agg_day_limit.png](PNG%2fn_citizen_data_history_filter_agg_day_limit.png)
...
![fn_summary_data_city.png](PNG%2fn_summary_data_city.png)

#### Функция, предоставляющая суммарные данные по городам. В разрезе городов за указанный промежуток времени

![fn_summary_data_city_time_limit.png](PNG%2fn_summary_data_city_time_limit.png)
...
![fn_summary_data_city_agg_month.png](PNG%2fn_summary_data_city_agg_month.png)
...
![fn_summary_data_city_last.png](PNG%2fn_summary_data_city_last.png)